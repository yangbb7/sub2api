export default {
  ...
  payment: {
    ...
    admin: {
      ...
      todayOrders: '今日订单',
      rangeRevenue: '所选范围实收',
      rangeOrders: '所选范围已支付订单',
      rangeAvgAmount: '已支付订单均额',
      rangePendingOrders: '范围内创建的待支付订单',
      orderCount: '订单数',
      avgAmount: '平均金额',
      revenue: '收入',
      dailyRevenue: '每日收入',
      ...
      searchOrders: '搜索订单...',
      exportOrders: '导出订单',
      exportingOrders: '正在导出...',
      exportOrdersSuccess: '订单导出成功',
      exportOrdersFailed: '订单导出失败',
      noOrdersToExport: '当前筛选条件下没有可导出的订单',
      allStatuses: '全部状态',
