  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openai: {
        ...
        configTomlHint: 'Place root settings before the first [table] in config.toml. Merge existing keys and tables instead of adding duplicates.',
      ...
      codexModelCatalog: {
        ...
        description: 'Fetch the group catalog with this API key. OpenAI setups use the client catalog by default. To use a local catalog, download it, save it at the shown path, then enable it below. This file does not update automatically; download it again and restart Codex after changes.',
        enable: 'I saved the catalog at the shown path; enable it in the configuration',
        model: 'Model',
        fetch: 'Fetch catalog',
        retry: 'Retry',
