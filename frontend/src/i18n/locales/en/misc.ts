export default {
  ...
  payment: {
    ...
    admin: {
      ...
      rangeRevenue: 'Paid Revenue in Range',
      rangeOrders: 'Paid Orders in Range',
      rangeAvgAmount: 'Average Paid Order',
      rangePendingOrders: 'Pending Orders Created in Range',
      ...
      exportOrdersFailed: 'Failed to export orders',
      noOrdersToExport: 'No orders match the current filters',
