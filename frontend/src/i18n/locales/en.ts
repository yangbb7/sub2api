export default {
  ...
  auth: {
    ...
    affiliateReferralApplied: 'Joined from an invite link. Affiliate code: {code}',
  ...
  usage: {
    ...
    snapshotUnavailable: 'Not captured for this request.',
    truncated: 'Truncated',
  ...
  admin: {
    ...
    accounts: {
      ...
      crsBaseUrlPlaceholder: 'e.g. http://127.0.0.1:13000',
    ...
    ops: {
      ...
      diagnosis: {
        ...
        diskCriticalImpact: 'Database writes, logs, build cache, or container layer writes may fail',
        diskCriticalAction: 'Clean old images, logs, and temporary files, or expand disk capacity',
        diskHigh: 'Disk usage elevated ({usage}%)',
        diskHighImpact: 'Low free space reduces the safety margin for deploys and database writes',
        diskHighAction: 'Check disk growth trend and clean unused images or historical logs',
      ...
      tooltips: {
        ...
        disk: 'Disk usage, including used and total capacity visible to the gateway runtime.',
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplier: 'CNY to USD Credit Rate',
        balanceRechargeMultiplierHint: 'Default USD balance credited for CNY payment methods. Provider instances can override it; crypto wallet defaults to 1 USDC = 1 USD.',
        ...
        providerCoinbase: 'Coinbase Business',
        ...
        field_apiKeyId: 'API Key ID',
        field_apiKeySecret: 'API Key Secret',
        ...
        field_creditRateToUsd: 'USD credit rate',
        ...
        field_coinbaseApiBaseHint: 'Default Coinbase Business API: https://business.coinbase.com/api/v1. Change it only for sandbox, proxy, or local testing.',
        field_coinbaseCurrencyHint: 'USDC is recommended. If you choose USD or another fiat currency, Coinbase handles conversion and settlement according to its checkout rules.',
        field_creditRateToUsdHint: 'USD balance credited for each 1 unit of this provider payment currency. Empty uses the global rate for CNY and 1 for USD/USDC.',
        ...
        coinbaseWebhookHint: 'Configure the following URL as a Webhook endpoint in Coinbase Business. Subscribe to checkout.payment.success, checkout.payment.failed, and checkout.payment.expired; add refund events if needed.',
