...
func TestUsageLogSelectColumnsIncludesUpstreamResponseAuditFields(t *testing.T) {
	require.Contains(t, usageLogSelectColumns, "upstream_model, upstream_response_model, upstream_model_mismatch, group_id")
}
