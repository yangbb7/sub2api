...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	...
	log := &service.UsageLog{
		...
		RequestSnapshot:           usageCallSnapshotFromNullJSON(requestSnapshot),
		ResponseSnapshot:          usageCallSnapshotFromNullJSON(responseSnapshot),
...
func nullUsageCallSnapshotJSON(v *service.UsageCallSnapshot) any {
...
func usageCallSnapshotFromNullJSON(v sql.NullString) *service.UsageCallSnapshot {
	if !v.Valid || strings.TrimSpace(v.String) == "" {
		return nil
	}
	var out service.UsageCallSnapshot
