...
var providerSensitiveConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeCoinbase:  {"apikey": {}, "apikeysecret": {}, "webhooksecret": {}},
}
...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeCoinbase:  {"apikey": {}, "apikeyid": {}, "apikeysecret": {}, "webhooksecret": {}, "apibase": {}, "currency": {}},
}
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeAirwallex: true, payment.TypeCoinbase: true,
}
