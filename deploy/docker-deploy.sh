#!/bin/bash
# =============================================================================
# AI Gateway Docker Deployment Preparation Script
# =============================================================================
# This script prepares deployment files for AI Gateway:
...
GITHUB_RAW_URL="https://raw.githubusercontent.com/yangbb7/sub2api/main/deploy"
...
main() {
    echo ""
    echo "=========================================="
    echo "  AI Gateway Deployment Preparation"
    echo "=========================================="
    echo ""
