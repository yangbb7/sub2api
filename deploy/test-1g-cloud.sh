...
for expected in 'mem_limit: 96m' 'mem_limit: 896m' 'mem_limit: 320m' 'mem_limit: 128m' 'GOMAXPROCS=${GOMAXPROCS:-2}' 'GOMEMLIMIT=${GOMEMLIMIT:-640MiB}' 'GATEWAY_STREAM_KEEPALIVE_INTERVAL=${GATEWAY_STREAM_KEEPALIVE_INTERVAL:-0}' 'GATEWAY_OPENAI_STREAM_GOVERNANCE_ENABLED=${GATEWAY_OPENAI_STREAM_GOVERNANCE_ENABLED:-false}' 'GATEWAY_OPENAI_STREAM_GOVERNANCE_ROLLOUT_PERCENT=${GATEWAY_OPENAI_STREAM_GOVERNANCE_ROLLOUT_PERCENT:-10}' 'GATEWAY_OPENAI_STREAM_GOVERNANCE_TOTAL_BUDGET_SECONDS=${GATEWAY_OPENAI_STREAM_GOVERNANCE_TOTAL_BUDGET_SECONDS:-10}' 'GATEWAY_OPENAI_STREAM_GOVERNANCE_FIRST_ATTEMPT_BUDGET_SECONDS=${GATEWAY_OPENAI_STREAM_GOVERNANCE_FIRST_ATTEMPT_BUDGET_SECONDS:-6}' '127.0.0.1:${SERVER_PORT:-18080}:18080' '80:80' '443:443'; do
